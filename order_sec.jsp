...
<head>
  ...
  <script type="text/javascript" src="TW/js/swiper.js"></script>

  <script type="text/javascript" src="TW/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="TW/js/jquery.transit.min.js"></script>
<!--   <script type="text/javascript" src="js/easing.js"></script>
  <script type="text/javascript" src="js/round.js"></script> -->
  <script src="TW/js/common.js" type="text/javascript"></script>
  <script src="js/orderSec.js" type="text/javascript"></script>
  <script src="TW/js/commonnew.js" type="text/javascript"></script>
<!-- 移动端   -->
  <script src="TW/js/common_m.js" type="text/javascript"></script>
 <%
            ...
            <div class="submit-payment_bd">
              ...
              <div class="payment-list clearfix">
                ...
                <div class="payment-item bank-card">
                  <input type="radio" name="payment" id="bankPay" value="5" />
                  <label for="">
