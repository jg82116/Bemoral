...
<!--   <script type="text/javascript" src="js/easing.js"></script>
  ...
  <script src="js/orderLast.js" type="text/javascript"></script>
      ...
      <div class="order-wrap">
        <div class="osubmit-item">
          <div class="osubmit-item_title clearfix">
            <div class="pull-left">
                <img src="./images/payment_confirm.png" />
                <span>付款確認信息</span>
            </div>
            <div class="pull-right">
            </div>
          </div>
          <div class="osubmit-item_bd payment-confirm">
            <div class="payment-confirm_hd">您的訂單已生成！<br>
              我們將盡快為您準備及發貨</div>
            <div class="payment-confirm_bd">
              <div class="payment-orderno">
                <p>訂單編號  <span id="paymentOrderNo"></span></p>
                您已獲取  <span class="order-score">0</span> 積分
              </div>
              <div class="payment-info_list clearfix">
                <div class="payment-left clearfix">
                  <div class="payment-info_title">
                    <p>購物車總價</p>
                    <p>郵費</p>
                    <p>優惠金額</p>
                    <p>總金額</p>
                  ...
                  <div class="payment-info_content">
                    <p>NT$ <span id="cartTotalMoney"></span></p>
                    <p>NT$ 0</p>
                    <p>-NT$ 0</p>
                    <p>NT$ <span id="totalPayMoney"></span></p>
                  </div>
                </div>
                <div class="payment-right">
                  ...
                  <div class="payment-info_content">
                    ...
                    <p id="orderPerson"></p>
                    <p id="orderPhone"></p>
                    <p><span id="orderAddr"></span>
                      <span id="addrProvince"></span></p>
                  </div>
                </div>
              </div>
            </div>
            <div class="check-order_detail cart-next clearfix">
              <button class="btn btn-check_detail">去查看訂單詳情</button>
            </div>
          </div>
        </div>
      </div>
